...
final class FeedHookScripts {
    ...
    static final String INSTALL_HOOKS =
            "(function(){"
                    + "if(window.__tvdyPumpHookVersion>=2)return;"
                    + "window.__tvdyPumpHookVersion=2;window.__tvdyPumpHooked=true;"
                    + "try{"
                    ...
                    + "||/\\/aweme\\/favorite/i.test(u)||/\\/aweme\\/post/i.test(u)"
                    + "||/\\/mix\\/listcollection/i.test(u);"
                    + "}"
                    ...
                    + "try{"
                    + "var u=String(url||'');"
                    + "if(isFeedReportUrl(u)){window.__tvdyLastFeedUrl=u;}"
                    + "}catch(e){}"
